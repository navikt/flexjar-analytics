import { XAxis, YAxis, Tooltip, ResponsiveContainer, Line, LineChart, ReferenceLine } from "recharts";
    ...
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
              ...
              return (
                <div style={{
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                    <span style={{ fontSize: "1.5rem" }}>{ratingToEmoji(Math.round(data.average))}</span>
                    <span style={{ fontWeight: 600 }}>{data.average.toFixed(1)}</span>
        ...
        <Line 
          ...
          activeDot={{ fill: CHART_COLORS.primary, strokeWidth: 2, stroke: "#fff", r: 6 }}
        />
      </LineChart>
    </ResponsiveContainer>
  );
